...
### 1. [v] can_add_to_pon() — 偵測手牌中是否有可加槓的牌
...
- **c3ef1b3** feat(mahjong-py): 新增 can_add_to_pon() — 偵測可加槓的已碰刻子
...
- **420f217** feat(mahjong-py): 實作加槓（人機詢問）與搶槓掃描，加槓後補摸繼續出牌

### 3. [v] 加槓後掃描搶槓，搶槓勝出時加 +1 台
